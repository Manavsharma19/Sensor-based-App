 This Android app, developed in Android Studio, uses location of the user and can activate emergency call in case of SOS emergency. The app integrates a MySQL Database for data management and features Recyclerview for dynamic lists and fragments for a modular UI. It includes navigational components like menus, TabLayout, and ViewPager for a seamless user experience.
